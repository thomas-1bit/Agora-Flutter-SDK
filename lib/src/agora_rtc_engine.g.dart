...
RemoteAudioStats _$RemoteAudioStatsFromJson(Map<String, dynamic> json) =>
    RemoteAudioStats(
      ...
      frozenRateByCustomPlcCount: json['frozenRateByCustomPlcCount'] as int?,
      plcCount: json['plcCount'] as int?,
...
RemoteVideoStats _$RemoteVideoStatsFromJson(Map<String, dynamic> json) =>
    RemoteVideoStats(
      ...
      receivedBitrate: json['receivedBitrate'] as int?,
      decoderInputFrameRate: json['decoderInputFrameRate'] as int?,
...
RtcEngineContext _$RtcEngineContextFromJson(Map<String, dynamic> json) =>
    RtcEngineContext(
      ...
      agoraLibBaseUrl: json['agoraLibBaseUrl'] as String?,
    );
...
Map<String, dynamic> _$RtcEngineContextToJson(RtcEngineContext instance) {
  ...
  writeNotNull('agoraLibBaseUrl', instance.agoraLibBaseUrl);
  return val;
}
